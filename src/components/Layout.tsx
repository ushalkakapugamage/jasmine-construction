  ...
  return <header className={`site-header ${dark ? 'site-header--dark' : ''}`}>
    <div className="site-header__inner shell">
      ...
      <div className="header-actions">
        ...
        <Button href="/contact" className="header-cta">Start a project</Button>
    ...
    <div className={`mobile-menu ${isOpen ? 'mobile-menu--open' : ''}`} id="mobile-menu">
      <nav aria-label="Mobile navigation">
        ...
        <a href="/contact" onClick={() => setOpen(false)}><span>05</span>Start a project</a>
      </nav>
...
export function Footer() {
  ...
  return <footer className="site-footer">
    <div className="shell site-footer__main">
      ...
      <div className="footer-block"><span className="eyebrow">Explore</span>{links.map(([label, href]) => <a href={href} key={href}>{label}</a>)}<a href="/contact">Start a project</a></div>
